...
const Cart = () => {
  ...
  return (
    <>
    <div className=' bg-blue-700 text-white text-4xl text-center p-5 '>
    ...
    <div className=' w-full h-[623px] flex flex-row'>
        ...
        <div className=' w-[25%] pr-8 py-11'>
          ...
          <div className='border-[2px] border-[solid] border-[black] rounded-xl text-center p-2 flex flex-col gap-y-5 pb-8 bg-pink-100 mt-9'>

            <div className=' text-3xl font-bold text-purple-600'>BUY</div>
            ...
            <div className='flex flex-row gap-3'>
              ...
              <input className="border-[2px] border-[solid] border-[black] rounded-xl pl-3"type="text" value={Quantity} onChange={e=>{
            ...
            <div className=' flex justify-center'>
              <button className=' bg-blue-800 w-3/5 py-2 text-2xl text-white'>Proceed To Buy</button>
            </div>
