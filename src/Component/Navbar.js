...
<div className=" fixed w-full grid z-50 grid-cols-[0.65fr_0.35fr] justify-items-center  items-center bg-blue-950 text-white text-xl px-40 py-4 border-b-2 border-solid border-white">
    ...
    <div className="grid grid-cols-[repeat(3,minmax(0,1fr))] gap-6 items-center ">
        ...
        <a href="#"className="text-center  border-[2px] border-[solid] border-[white] rounded-[8px] p-0.5">Log In</a>
        <a href='#' className="text-center) bg-[white] text-blue-950 rounded-[8px] p-0.5 font-semibold">Sign Up</a>
    </div>
